  ...
  return (
    <div style={{ position: 'relative' }}>
        ...
        <div style={{
          ...
          {SUGGESTIONS.map(s => (
            <div key={s} onClick={() => submit(s)} style={{
              padding: '10px 16px', fontSize: 13, color: '#b0b3c0',
              cursor: 'pointer', borderBottom: '0.5px solid #2a2d3a',
            }}
      ...
      <div style={{
        ...
        <button onClick={() => setShowHints(v => !v)} style={{
          background: 'none', border: 'none', cursor: 'pointer',
          fontSize: 16, color: '#555', padding: '0 4px',
        }} title="Sample queries">✦</button>
        ...
        <input
          ...
          style={{
            ...
            fontSize: 14, color: '#e8eaf0', caretColor: '#7F77DD',
          }}
        />
        ...
        <button
          ...
          style={{
            ...
            color: isRunning ? '#555' : '#fff', fontSize: 13,
            fontWeight: 500, cursor: isRunning ? 'not-allowed' : 'pointer',
